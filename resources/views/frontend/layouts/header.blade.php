        ...
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            ...
            @php $total=0; @endphp
                ...
                <div class="mini-cart-item clearfix">
                    ...
                    <div class="mini-cart-img">
                        <a href="#"><img src="{{asset('frontend/product/'.$cart->image)}}" alt="Image"></a>
                        <span class="mini-cart-item-delete" href="/cart/delete/{{$cart->id}}"><i class="icon-cancel"></i></span>
                    </div>
                    <div class="mini-cart-info">
                        <h6><a href="#">{{$cart->name}}</a></h6>
                        <span class="mini-cart-quantity">{{$cart->price * $cart->quantity}}</span>
                    </div>
                </div>
            ...
            <div class="mini-cart-footer">
                <div class="mini-cart-sub-total">
                    <h5>Subtotal: <span>  @php $total += $cart->price * $cart->quantity; @endphp</span>
                {{$total}}</h5>
                </div>
                @endforeach
