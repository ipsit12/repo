    ...
    <div class="container">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-12 col-sm-12 text-center">
                Copyright © <span id="year"></span> <a href="https://edevlop.com/">EDevlop</a>. Designed   by <a href="https://edevlop.com/"> EDevlop </a> All
                rights reserved
            </div>
        </div>
    </div>
...
<!-- BACK-TO-TOP -->
<a href="#top" id="back-to-top"><i class="bi bi-caret-up"></i></a>
...
<script src="backend/assets/vendor/js/main.js"></script>
