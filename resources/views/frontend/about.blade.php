...
@section('content')
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{asset('/frontend/img/icons/icon-img/24.png')}}" alt="#">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center active">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{asset('/frontend/img/icons/icon-img/25.png')}}" alt="#">
                        </div>
                        <div class="ltn__feature-info">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{asset('/frontend/img/icons/icon-img/26.png')}}" alt="#">
                        </div>
                        <div class="ltn__feature-info">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-6 text-center">
                        <div class="ltn__feature-icon">
                            ...
                            <img src="{{asset('/frontend/img/icons/icon-img/27.png')}}" alt="#">
                        </div>
                        <div class="ltn__feature-info">
    ...
    <div class="ltn__counterup-area section-bg-1 bg-image bg-overlay-theme-black-80--- pt-115 pb-70" data-bs-bg="{{asset('/frontend/img/bg/30.jpg')}}">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <aside class="about-us-img-wrap about-img-right">
                        <img src="{{asset('/frontend/img/others/100.jpg')}}" alt="Banner Image">
                    </aside>
                </div>
            </div>
        </div>
