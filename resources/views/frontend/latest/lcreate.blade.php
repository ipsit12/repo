      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
          ...
          <div class="card-body p-4 p-sm-5">
            ...
            <form method="post" action="{{url('/lcreate/store')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-floating mb-3">
              ...
              <div class="form-floating mb-3">
                <input type="text" name="price" class="form-control" id="floatingInputUsername" placeholder="price" required autofocus>
