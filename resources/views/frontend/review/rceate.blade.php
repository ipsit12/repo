      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
          ...
          <div class="card-body p-4 p-sm-5">
            ...
            <form method="post" action="{{url('/rceate/store')}}" enctype="multipart/form-data">
            @csrf
            <div class="form-floating mb-3">
              ...
              <div class="form-floating mb-3">
                <input type="description" name="description" class="form-control" id="floatingPasswordConfirm" placeholder="description">
                <label for="floatingPasswordConfirm">description</label>
              </div>
