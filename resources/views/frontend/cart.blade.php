            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping-cart-inner">
                            ...
                            <table class="table">
                                ...
                                @php $total=0; @endphp
                                    ...
                                    <td class="cart_table--body_list">
                                                    <a class="cart__remove--btn" href="/cart/delete/{{$cart->id}}" aria-label="search button" type="button">
                                                        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="16px" height="16px"><path d="M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z"/></svg>
                                                    </a>
                                     </td>
                                        <td class="cart-product-image">
                                            <a href="product-details.html"><img src="{{asset('frontend/product/'.$cart->image)}}" alt="#"></a>
                                        </td>
                                        <td class="cart-product-info">
                                            <h4><a href="product-details.html">{{$cart->name}}</a></h4>
                                        </td>
                                        <td class="cart-product-price">{{$cart->price}}</td>
                                        ...
                                        <div>
                                        <td class="cart-product-subtotal">{{$cart->price * $cart->quantity}}</td>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <h4>Get best deals<a href="{{url('/shop')}}">shop now</a></h4>
                            </div>
                            <div class="col-md-4">
                                ...
                                <a href="javascript:void(0)" onclick="calculateAndRedirect()" class="theme-btn-1 btn btn-effect-1">Proceed to checkout</a>
</div>
...
<!-- <script>
  ...
  const cartItems = document.querySelectorAll('table');
  let totalPrice = 0;

  cartItems.forEach(item => {
    const price = parseFloat(item.getAttribute('cart-product-price'));
    totalPrice += price;
  });
...
// Call updateTotalPrice initially and whenever an item is added or removed from the cart
updateTotalPrice();
</script> -->
<!-- <script>
    $(document).ready(function(){
        $
        ('.cart-plus-minus').click(function(e){

      
        e.preventDefault();
        var inc_value=$(this).parents('#totalPrice').find('.cart-plus-minus-box').val();
        var value=parseInt(inc_value,10);
        value=isNaN(value)?0:value;
        if(value<10){
            value++;
            $(this).parents('#totalPrice').find('.cart-plus-minus-box').val(value);
        }
    });
});
</script> -->
<script>
    function calculateAndRedirect(){
        ...
        //console.log("total");
        window.location="{{url('/checkout')}}"+"?total="+total;
    }
</script>
@endsection